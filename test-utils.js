module.exports= {runTests,defineTest,assertEqual,assertNotEqual,assertThrowsError}
const testFns = []
 ...
 */
function defineTest (name, definition) {
 ...
 */
function assertEqual (value, expectedValue, message) {
 ...
 * @param {string=} message
 */
function assertNotEqual (value, expectedValue, message) {
  if (value === expectedValue) {
    const errorMsg = [
